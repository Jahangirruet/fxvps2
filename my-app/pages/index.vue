<template>
  <NuxtLayout>
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide pb-14 space-y-3 lg:space-y-6">
                    ...
                    <div class="xl:space-y-5 space-y-3 min-w-[250px]">
                      <div class="flex gap-3 items-center">
                        <img
                          ...
                          height="18"
                        />
                        <p class="text-lg text-black">Latest Hardware Tech.</p>
                      </div>
                      <div class="flex gap-3 items-center">
                        <img
                          src="~/assets/images/circle.svg"
                    ...
                    <div class="xl:space-y-5 space-y-3">
                      <div class="flex gap-3 items-center">
                        <img
                          ...
                          height="18"
                        />
                        <p class="text-lg text-black">24/7,Customer Support.</p>
                      </div>
                      <div class="flex gap-3 items-center">
                        <img
                          src="~/assets/images/circle.svg"
                          ...
                          height="18"
                        />
                        <p class="text-lg text-black">100% Uptime Guarantee.</p>
                      </div>
                      <div class="flex gap-3 items-center">
                        <img
                          src="~/assets/images/circle.svg"
                  ...
                  <div class="flex items-center gap-4 pt-2">
                    <a
                      href="https://secure.fxvps.pro/register.php"
                      target="_blank"
                    ...
                    >
                      ...
                      >
                        <span class="group-hover:text-white">Register Now</span>
                      </span>
                    </a>
                    ...
                    <div class="xl:space-y-5 space-y-3 min-w-[250px]">
                      ...
                      <div class="flex gap-3 items-center">
                        <img
                          ...
                          height="18"
                        />
                        <p class="text-lg text-black">Dedicated Environments</p>
                      </div>
                    </div>
                    <div class="xl:space-y-5 space-y-3">
                      <div class="flex gap-3 items-center">
                      ...
                      <div class="flex gap-3 items-center">
                        <img
                          ...
                          height="18"
                        />
                        <p class="text-lg text-black">99.9% Uptime Guarantee</p>
                      </div>
                    </div>
                  </div>
                  <div class="flex items-center gap-4 pt-2">
                ...
                <div class="swiper-slide space-y-3 pb-14 lg:space-y-6">
                    ...
                    <div class="xl:space-y-5 space-y-3">
                      ...
                      <div class="flex gap-3 items-center">
                        <img
                          ...
                          height="18"
                        />
                        <p class="text-lg text-black">1 Gbps Dedicated Port</p>
                      </div>
                      <div class="flex gap-3 items-center">
                        <img
                          src="~/assets/images/circle.svg"
                  ...
                  <div class="flex items-center gap-4 pt-2">
                    ...
                    <router-link to="/pricing">View Services </router-link>
                  </div>
                </div>
              </div>
            ...
            <div class="flex items-start gap-2 flex-col sm:flex-row">
              ...
              <div class="space-y-4">
                ...
                <ul class="grid gap-2">
                  ...
                  <li class="font-bold text-sm text-primary">$3.00 / Month</li>
            ...
            <div class="flex items-start gap-2 flex-col sm:flex-row">
              ...
              <div class="space-y-4">
                ...
                <ul class="grid gap-2">
                  ...
                  <li class="font-bold text-sm text-primary">$5.90 / Month</li>
                  <li class="font-normal text-black text-sm">1 Core CPU</li>
                </ul>
                <a
                  href="#"
            ...
            <div class="flex items-start gap-2 flex-col sm:flex-row">
              ...
              <div class="space-y-4">
                ...
                <ul class="grid gap-2">
                  ...
                  <li class="font-bold text-sm text-primary">$9.50 / Month</li>
      ...
      <div class="container mx-auto space-y-12 xl:px-32">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-7 2xl:gap-12">
          ...
          >
            ...
            <figure>
              <img
                src="~/assets/images/bookmark-fav-dynamic-premium.png"
            ...
            <p class="text-base text-black text-center !leading-[1.7]">
              ...
              trading, auto-copy trading etc. Our Web regular windows VPS plans
              will give you rock-solid fast trading experience.
            </p>
          ...
          >
            ...
            <figure>
              <img
                src="~/assets/images/bell-dynamic-premium.png"
          ...
          >
            ...
            <figure>
              <img
                src="~/assets/images/trophy-dynamic-premium.png"
        ...
        >
          ...
          >
            ...
            >
              <figure>
                <img
                  src="~/assets/images/Flash_drive_perspective_matte.png"
            ...
            >
              <figure>
                <img
                  src="~/assets/images/Settings_perspective_matte.png"
            ...
            >
              <figure>
                <img
                  src="~/assets/images/Stopwatch_perspective_matte.png"
            ...
            >
              <figure>
                <img src="~/assets/images/window.png" alt="window.png" />
              </figure>
              <h2 class="text-xl sm:text-2xl font-bold text-black text-center">
                RDP
              </h2>
            ...
            >
              <figure>
                <img
                  src="~/assets/images/perspective_matte.png"
            ...
            >
              <figure>
                <img
                  src="~/assets/images/Increase_perspective_matte.png"
              ...
              <p class="text-center text-base font-normal">For Forex Trading</p>
            </div>
          </div>
        </div>
      </div>
        ...
        >
          <article class="space-y-3 max-w-[1050px]">
            ...
            <p class="text-base sm:text-lg !leading-[1.6] sm:!leading-[1.9]">
              ...
              hand the user a wide range of profits. Those facilities could be a
              dedicated VPS service, 24/7 support capability, optimized trading
              platform supportability, etc. Fx VPS Pro has been strictly
              maintaining the hallmark of strong technical & professional
              reliability in forex VPS hosting from its very first day.
            </p>
          </article>
          <figure class="shrink-0">
            <img
              src="~/assets/images/crown-dynamic-color.png"
          ...
          >
            <div class="flex gap-3 items-start">
              ...
              <article class="space-y-4">
                ...
                <p class="text-dark text-base md:text-lg">
                  ...
                  experience. It could be any platform or website; this VPS can
                  deliver 3x faster speed than the regular server.
                </p>
              </article>
            </div>
            <div class="flex gap-3 items-start">
            ...
            <div class="flex gap-3 items-start">
              ...
              <article class="space-y-4">
                ...
                <p class="text-dark text-base md:text-lg">
                  Forex VPS possesses the capacity of delivering the latency in
                  a millisecond. Our data centers are located at New York,
            ...
            <div class="flex gap-3 items-start">
              ...
              <article class="space-y-4">
                ...
                <p class="text-dark text-base md:text-lg">
                  Our servers own enough technical resource to prevent any sort
                  of security breach or cyber-attack. Our backup system(DDoS)
                  will keep your data intact.
                </p>
              </article>
            </div>
          </div>
    ...
    <section class="sm:px-4 pb-8 sm:pb-12 pt-14 lg:pt-20 overflow-x-clip">
      <div class="container mx-auto space-y-12">
        ...
        >
          ...
          >
            <img
              src="~/assets/images/medal-dynamic-premium.png"
          ...
          >
            <div class="flex gap-3 items-start">
              <figure class="shrink-0 mt-2">
                <img src="~/assets/images/circle-blue.svg" alt="circle" />
              </figure>
              <article class="space-y-4">
                <h3 class="text-xl lg:text-2xl font-bold text-black">
                  Free Installation
                ...
                <p class="text-dark text-base md:text-lg">
                  Our honored clients will get free installation & high-quality
                  tech support from the beginning to the last day of our
                  contract.
                </p>
              </article>
            </div>
            ...
            <div class="flex gap-3 items-start">
              ...
              <article class="space-y-4">
                ...
                <p class="text-dark text-base md:text-lg">
                  Potential clients are getting access to the desired package at
    ...
    <!-- start coding for Choose The Most Suitable Forex section  -->
    <section class="px-4 pb-8 sm:pb-12 pt-8 sm:pt-12 lg:pt-16 overflow-x-clip">
      <div class="container mx-auto">
        <div
        ...
        >
          <div class="w-full md:w-7/12 space-y-6 lg:space-y-10">
            <div class="space-y-3">
              ...
              <p class="text-base md:text-lg text-black !leading-[1.8]">
                Forex VPS offers a full dedicated server to its clients. Rather
                than a leap service we act as according to our featured
                criteria. That’s why we give full dedication & effort to ensure
                our dedicating service quality. The factors we emphasize on to
                keep our service dedicated are in the following;
              </p>
            </div>
            <ul class="grid gap-2">
            ...
            <p class="text-base md:text-lg text-black">
              With FX VPS dedicated plan, our clients will have a wide range of
              opportunity to choose the most suitable server according to the
              needs. We offer four modules; DS 1, DS 2, DS 3, DS 4 categorized
              by:
            </p>
            <ul class="grid gap-2">
              <li class="flex gap-3 items-center">
          ...
          <div class="w-full md:w-5/12">
            <figure class="px-6 md:px-0 md:-mr-6 lg:-mr-14 2xl:-mr-44">
              <img class="w-full" src="~/assets/images/img-1.svg" alt="img" />
            </figure>
          </div>
        </div>
      </div>
            ...
            <div class="grid gap-1 w-full lg:w-1/2">
              <div class="group space-y-4">
                ...
                >
                  ...
                  >
                    <p class="text-base md:text-lg text-black">
                      The term “FOREX VPS” involves a virtual private server
                      system that is mainly applied in forex trading. Basically,
                      these servers host MT4/MT5 trading platforms 24/7
                      uninterruptedly. In forex VPS service the hardware
                      resources are allotted under a vast server arrangement.
                      Forex servers get optimized for meta-trading & latency for
                      conducting rigorous trading activities. VPS service
                      providers arrange respective plans for the individual
                      requirements based on disk space, CPU capacity, latency &
                      much more. Dedicated server plans are very common nowadays
                      because most of the pro traders prefer them over other
                      server policy.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  >
                    <p class="text-base md:text-lg text-black">
                      ...
                      necessary setup for you via team viewer. Normally Forex
                      VPS is very easy to use as you will be using standard
                      Remote Desktop Program software (comes by default with
                      every Windows edition) to connect to your VPS. We also
              ...
              <div class="group space-y-4">
                ...
                >
                  ...
                  >
                    <p class="text-base md:text-lg text-black">
                      We manually review every order & manually setup every vps
                      for best performances. So, account setup can take upto 5
                      mins time but usually much quicker.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="grid gap-1 w-full lg:w-1/2">
              <div class="group space-y-4">
                ...
                >
                  ...
                  >
                    <p class="text-base md:text-lg text-black">
                      We accept Paypal, Neteller, Skrill, Webmoney, Perfect
                      Money, Payza, VISA/Mastercard .
                    </p>
                  </div>
                </div>
              </div>
              <div class="group space-y-4">
                ...
                >
                  ...
                  >
                    <p class="text-base md:text-lg text-black">
                      Yes. All accounts can be upgraded any time .Just write an
                      email to support@fxvps.pro with the plan to which you want
                      to upgrade your Forex VPS.
                    </p>
                  </div>
                </div>
              </div>
              <div class="group space-y-4">
                ...
                >
                  ...
                  >
                    <p class="text-base md:text-lg text-black">
                      There are many advantages of using Forex VPS but here is
                      the list of the most important ones:
                    </p>
                    <p class="text-base md:text-lg text-black">
                      Internet Connection Stability - Our VPS solution offers a
                      professional setup. We have a high grade Internet
                      connection and multiple backup connections in case one or
                      more go down. In comparison a Home Internet connection has
                      no backup and can vary in reliability.
                    </p>
                    <p class="text-base md:text-lg text-black">
                      Power Consumption - Our VPS solution offers a professional
                      setup. We have a high grade Internet connection and
                      multiple backup connections in case one or more go down.
                      In comparison a Home Internet connection has no backup and
                      can vary in reliability.
                    </p>
                    <p class="text-base md:tsext-lg text-black">
                      Keep your PC desktop tidy - If you run your MT4/mt5 on
                      your PC you will always have the terminal on the desktop.
                      This can be annoying and also you could mistakenly close
                      the terminal while closing other applications. With a VPS
                      it is out of site unless you have your RDP connection
                      running. Access from anywhere - You can remotely access
                      your VPS from anywhere you have an Internet connection
                    </p>
                  </div>
                </div>
              </div>
    ...
    <section class="px-4 pb-8 sm:pb-12 pt-14 lg:pt-16 overflow-x-clip relative">
      <img
        class="absolute top-1/2 -translate-y-1/2 left-0 opacity-20 md:block hidden"
        src="~/assets/images/bg-verify.png"
        alt="vg-verify"
      />
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
          <div class="space-y-3">
            ...
            <p class="text-base lg:text-lg text-black !leading-[1.5]">
              ...
              within a larger server system. This service is mainly required for
              hosting purpose backed by big chunks of hardware system placed in
              specific data centers or locations. Most of the VPS service
              provider presents customizable options for its users. When the
              trader selects a provider, that gives full access to its plans
              comprising with the maximum amount of RAM size, bandwidth & server
              capacity so the client can pick up the most appropriate one for
              trading.
            </p>
          </div>
          <div class="space-y-3">
            ...
            <p class="text-base lg:text-lg text-black !leading-[1.5]">
              ...
              trading accounts without any disturbance or failure. -Latency: The
              ultra-low latency required for forex trading cannot be maintained
              typical ISP’s. Only the latency optimized servers are capable to
              produce lightning fast business execution. -Back-up & Security In
              VPS hosting service a continuous data backup process will be
              running simultaneously with your trading.
            </p>
          </div>
          <div class="space-y-3">
            <h3 class="text-xl font-bold text-black">
            ...
            <ul class="grid gap-1">
              <li class="text-base lg:text-lg text-black !leading-[1.5]">
                <strong>Step 1: </strong> Download the MT4/MT5 directly from the
                official website.
              </li>
              <li class="text-base lg:text-lg text-black !leading-[1.5]">
                <strong>Step 2: </strong> Select “Remote Desktop Protocol” from
                the search bar.
              </li>
              <li class="text-base lg:text-lg text-black !leading-[1.5]">
                <strong>Step 3: </strong> Enter the login credential provided by
              ...
              <li class="text-base lg:text-lg text-black !leading-[1.5]">
                <strong>Step 5: </strong> After successful installing enter the
                login details that were provided from your brokerage house. On
                successful completion of these steps, your MT4/MT5 platform
                hosting will be initiated.
              </li>
            </ul>
          </div>
          <div class="space-y-3">
      ...
      <div class="container mx-auto space-y-12">
        ...
        >
          <div class="space-y-7 w-full md:w-8/12">
            <div class="space-y-3">
              ...
              <p class="text-base md:text-lg text-black !leading-[1.5]">
                Talk to one of out VPS specialist who will review your needs and
                propose a tailored hosting solution that will match your
          ...
          <div class="flex justify-center w-full md:w-4/12">
            <figure class="">
              <img
                src="~/assets/images/rocket-dynamic-premium.png"
